...
<body>
    ...
    <div class="container">
        <div class="admin_search">
            <form class="d-flex" role="search" form action="http://localhost/quads/index.php/napwc/search_appointment"
                method="post">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo 'http://localhost/quads/index.php/napwc/delete_appointment/' . $item[$i]->id; ?>"
